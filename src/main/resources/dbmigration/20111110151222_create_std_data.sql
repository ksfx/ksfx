-- admin : 12345
INSERT INTO `user` (`id`,`email`,`enabled`,`first_name`,`last_name`,`password`,`username`) VALUES (1,NULL,b'1',NULL,NULL,'ee26ad7caaf17fe2b0e7c16525df3c540e57f891','admin');

INSERT INTO `role` (`id`,`name`) VALUES (1,'ROLE_ADMIN');

INSERT INTO `user_roles` (`user`,`roles`) VALUES (1,1);
