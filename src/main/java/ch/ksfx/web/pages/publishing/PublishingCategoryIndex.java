...
@Secured({"ROLE_ADMIN"})
public class PublishingCategoryIndex
{
    @Inject
    ...
    {
        return publishingConfigurationDAO.getAllPublishingCategories();
    }

    public void onActionFromDelete(Long publishingCategoryId)
    {
        publishingConfigurationDAO.deletePublishingCategory(publishingConfigurationDAO.getPublishingCategoryForId(publishingCategoryId));
    }
}
