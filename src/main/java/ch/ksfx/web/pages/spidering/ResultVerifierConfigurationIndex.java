 ...
 */
public class ResultVerifierConfigurationIndex
{
    @Inject
    ...
    {
        return resultVerifierConfigurationDAO.getAllResultVerifierConfigurations();
    }

    public void onActionFromDelete(Long resultVerifierConfigurationId)
    {
        resultVerifierConfigurationDAO.deleteResultVerifierConfiguration(resultVerifierConfigurationDAO.getResultVerifierConfigurationForId(resultVerifierConfigurationId));
    }
}
