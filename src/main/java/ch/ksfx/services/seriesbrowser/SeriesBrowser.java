...
package ch.ksfx.services.seriesbrowser;
...
public class SeriesBrowser
{
	...
	public SeriesBrowser(TimeSeriesDAO timeSeriesDAO, CategoryDAO categoryDAO)
	{
				...
				for (String node : nodes) {
					...
					if (parts != null && ntn.getName().equals(parts[0])) {
						...
						if (ntn != null && !openedNodes.contains(ntn.getLocator())) {
							...
							openNode(ntn, markup, nodes, filteredSeriesNames, openedNodes);
	...
	public void openNode(NavigationTreeNode ntn, StringBuilder markup, List<String> nodes, List<String> filteredSeriesNames, List<String> openedNodes)
	{
