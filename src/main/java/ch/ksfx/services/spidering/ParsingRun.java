...
public class ParsingRun implements Runnable
{
    ...
    public ParsingRun(SystemLogger systemLogger, Spidering spidering, ServiceProvider serviceProvider)
    {
    ...
    public void run()
    {
        ...
        ResultVerifierDAO resultVerifierDAO = new EbeanResultVerifierDAO(serviceProvider, systemLogger);
        ...
        try {
            ...
            ActivityInstanceRunner activityInstanceRunner = (ActivityInstanceRunner) serviceProvider.getService(ActivityInstanceRunner.class);
