...
import ch.ksfx.services.spidering.http.HttpUserAgentHeaders;
import ch.ksfx.services.spidering.http.WebEngine;
...
public class SpideringRun implements Runnable
{
    ...
    public SpideringRun(SystemLogger systemLogger, Spidering spidering, ParsingRunner parsingRunner, ServiceProvider serviceProvider)
    {
        this.systemLogger = systemLogger;
        this.spidering = spidering;
        this.parsingRunner = parsingRunner;
        this.resourceLoaderPluginDAO = new EbeanResourceLoaderPluginDAO(systemLogger, serviceProvider);
    }
