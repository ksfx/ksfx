...
@Repository
public class EbeanResultUnitModifierConfigurationDAO implements ResultUnitModifierConfigurationDAO
{
    @Override
    public void saveOrUpdate(ResultUnitModifierConfiguration resultUnitModifierConfiguration)
    {
        if (resultUnitModifierConfiguration.getId() != null) {
            Ebean.update(resultUnitModifierConfiguration);
        } else {
            Ebean.save(resultUnitModifierConfiguration);
        }
    }
    ...
    {
        return Ebean.find(ResultUnitModifierConfiguration.class).findList();
    }

    @Override
    public Page<ResultUnitModifierConfiguration> getResultUnitModifierConfigurationsForPageable(Pageable pageable)
    {
        ExpressionList expressionList = Ebean.find(ResultUnitModifierConfiguration.class).where();
        ...
        Page<ResultUnitModifierConfiguration> page = new PageImpl<ResultUnitModifierConfiguration>(expressionList.findList(), pageable, expressionList.findCount());
    ...
    {
        return Ebean.find(ResultUnitModifierConfiguration.class, resultUnitModifierConfigurationId);
    }

    @Override
    public void deleteResultUnitModifierConfiguration(ResultUnitModifierConfiguration resultUnitModifierConfiguration)
    {
        Ebean.delete(resultUnitModifierConfiguration);
    }
}
